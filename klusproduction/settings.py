...
ROOT_URLCONF = 'klusproduction.urls'
TEMPLATES = [
        {
...
WSGI_APPLICATION = 'klusproduction.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'myklushoek@gmail.com'
EMAIL_HOST_PASSWORD = 'bptmcqhrgmgmjops'
EMAIL_USE_TLS = True
